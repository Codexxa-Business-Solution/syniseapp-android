        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(top: parentHeight*0.025, left: parentWidth*0.04, right: parentWidth*0.0),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
              ...
              Padding(
                padding: EdgeInsets.only(top: parentHeight*0.025, left: parentWidth*0.04, right: parentWidth*0.04),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
              ...
              Padding(
                padding: EdgeInsets.only(top: parentHeight*0.025, right: parentWidth*0.04),
                child: Row(
                    ...
                    GestureDetector(
                      ...
                      onTap: (){
                        if(bidController.text.isNotEmpty &&
                            double.parse(bidController.text) >= double.parse(openPrice) ){
                          print("Done");
                        }
                      },
                      child: Container(

  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: Padding(
        padding: EdgeInsets.only(bottom: SizeConfig.screenHeight*0.03, right: SizeConfig.screenWidth*0.02),
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(right: parentWidth*0.014),
                  child: Container(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Padding(
                        padding:  EdgeInsets.only(top: parentHeight*0.01,left: parentWidth*0.27),
                        child: Text("Date :",
                          style: TextStyle(
                              color: Colors.black,
            ...
            Row(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(left: parentWidth*0.02,top: parentHeight*0.022),

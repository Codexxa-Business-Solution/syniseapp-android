...
class _TenderFeedbackScreenState extends State<TenderFeedbackScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: ListView(
        shrinkWrap: true,
        children: [
          Container(child: allReview(SizeConfig.screenHeight, SizeConfig.screenWidth)),
  ...
  Widget addFeedback(double parentHeight,double parentWidth){
    return Column(
      ...
      children: [
        Padding(
          padding: EdgeInsets.only(top: parentHeight*0.02,right: parentWidth*0.35),
          child: const Text("Additional Feedback or Input",style: TextStyle( color: Colors.black,
              fontSize: 16,
              fontWeight: FontWeight.w400,
              fontFamily: 'Robot_Regular'),),
        ),

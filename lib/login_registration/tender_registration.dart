...
class TenderRegistration extends StatefulWidget {
  const TenderRegistration({Key? key}) : super(key: key);

  @override
  State<TenderRegistration> createState() => _TenderRegistrationState();
}

class _TenderRegistrationState extends State<TenderRegistration> {
          ...
          child: GestureDetector(
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => AuctionDrawerScreen()));
            },
            child: Container(
              decoration: BoxDecoration(
                  color: CommonColor.TENDER_BOX_TEXT,
